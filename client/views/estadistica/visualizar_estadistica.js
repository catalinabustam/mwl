	...
	var reportda=reportdate.value
	   var startdate=new Date(reportda.slice(0,10))
	    ...
	    var report = {
	      ...
	      CDR_XENETIX:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"XENETIX 300"}).count(),
	      CDR_XENETIX_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"XENETIX 300",donacion:"no"}).count(),
		  CDR_XENETIX_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"XENETIX 300",donacion:"si"}).count(),
		  CDR_XENETIX_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"XENETIX 300",donacion:"si",donacionentidad:false}).count(),
		  CDR_XENETIX_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"XENETIX 300",donacion:"si",donacionentidad:true}).count(),
		  CDR_XENETIX_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"XENETIX 300",donacion:"no",tipoampolla:"abierta"}).count(),  
	      ...
	      CDR_HEXA:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"HEXABRIX 320"}).count(),
	      CDR_HEXA_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"HEXABRIX 320",donacion:"no"}).count(),
		  CDR_HEXA_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"HEXABRIX 320",donacion:"si"}).count(),
		  CDR_HEXA_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"HEXABRIX 320",donacion:"si",donacionentidad:false}).count(),
		  CDR_HEXA_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"HEXABRIX 320",donacion:"si",donacionentidad:true}).count(), 
		  CDR_HEXA_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"CDR",nombre:"HEXABRIX 320",donacion:"no",tipoampolla:"abierta"}).count(),  
	      ...
	      TODAS_XENETIX:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"XENETIX 300"}).count(),
	      TODAS_XENETIX_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"XENETIX 300",donacion:"no"}).count(),
		  TODAS_XENETIX_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"XENETIX 300",donacion:"si"}).count(),
		  TODAS_XENETIX_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"XENETIX 300",donacion:"si",donacionentidad:false}).count(),
		  TODAS_XENETIX_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"XENETIX 300",donacion:"si",donacionentidad:true}).count(),
		  TODAS_XENETIX_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"XENETIX 300",donacion:"no",tipoampolla:"abierta"}).count(),
		  ...
		  TODAS_HEXA:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"HEXABRIX 320"}).count(),
	      TODAS_HEXA_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"HEXABRIX 320",donacion:"no"}).count(),
		  TODAS_HEXA_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"HEXABRIX 320",donacion:"si"}).count(),
		  TODAS_HEXA_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"HEXABRIX 320",donacion:"si",donacionentidad:false}).count(),
		  TODAS_HEXA_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"HEXABRIX 320",donacion:"si",donacionentidad:true}).count(), 
		  TODAS_HEXA_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},nombre:"HEXABRIX 320",donacion:"no",tipoampolla:"abierta"}).count(),	
