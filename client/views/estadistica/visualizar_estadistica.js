Template.visualizarestadistica.rendered = function() {
	...
	var reportda=reportdate.value
	   var startdate=new Date(reportda.slice(0,10))
	    ...
	    var report = {
  	      HOSPITAL_GADO:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST"}).count(),
		  HOSPITAL_GADO_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",donacion:"no"}).count(),
		  HOSPITAL_GADO_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",donacion:"si"}).count(),
		  HOSPITAL_GADO_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",donacion:"si",donacionentidad:false}).count(),
		  HOSPITAL_GADO_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",donacion:"si",donacionentidad:true}).count(),
		  HOSPITAL_GADO_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",donacion:"no",tipoampolla:"abierta"}).count()-Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",donacion:"si",tipoampolla:"nueva"}).count(),
		  HOSPITAL_GADO_consumo:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST",tipoampolla:"nueva"}).count(),
		 // HOSPITAL_GADO_inventario:Contrasts.findOne({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"GADOVIST"}, {sort: {submitted: -1}}),

		  HOSPITAL_DOTA:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM"}).count(),
	      HOSPITAL_DOTA_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",donacion:"no"}).count(),
		  HOSPITAL_DOTA_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",donacion:"si"}).count(),
		  HOSPITAL_DOTA_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",donacion:"si",donacionentidad:false}).count(),
		  HOSPITAL_DOTA_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",donacion:"si",donacionentidad:true}).count(),
		  HOSPITAL_DOTA_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",donacion:"no",tipoampolla:"abierta"}).count()-Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",donacion:"si",tipoampolla:"nueva"}).count(),
	      HOSPITAL_DOTA_consumo:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM",tipoampolla:"nueva"}).count(),
	     // HOSPITAL_DOTA_inventario:Contrasts.findOne({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"DOTAREM"}, {sort: {submitted: -1}}),

	      HOSPITAL_PRIMO:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST"}).count(),
	      HOSPITAL_PRIMO_sindona:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",donacion:"no"}).count(),
		  HOSPITAL_PRIMO_condona_tot:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",donacion:"si"}).count(),
		  HOSPITAL_PRIMO_condona_enf:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",donacion:"si",donacionentidad:false}).count(),
		  HOSPITAL_PRIMO_condona_ent:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",donacion:"si",donacionentidad:true}).count(), 
	  	  HOSPITAL_PRIMO_aprove:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",donacion:"no",tipoampolla:"abierta"}).count()- Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",donacion:"si",tipoampolla:"nueva"}).count(),
		  HOSPITAL_PRIMO_consumo:Contrasts.find({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST",tipoampolla:"nueva"}).count(),
		 // HOSPITAL_PRIMO_inventario:Contrasts.findOne({submitted: {$gte: startdate, $lt: enddate},sede:"HOSPITAL",nombre:"PRIMOVIST"},  {sort: {submitted: -1}}),
